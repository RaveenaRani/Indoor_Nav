                    ...
                    for line in justified_table_final:
                        if count % 2 != 0:
                            ...
                            dataset = {
                                'length(cm)' : length,
                                'time' : timestamp,
                                rules.key()[0] : rules.values()[0],
                                rules.key()[1] : rules.values()[1],
                                rules.key()[2] : rules.values()[2],
                                rules.key()[3] : rules.values()[3],
                                rules.key()[4] : rules.values()[4],
                                rules.key()[5] : rules.values()[5],
                            }
